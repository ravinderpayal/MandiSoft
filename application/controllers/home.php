...
class Home extends CI_Controller {
    ...
    function index() {
        ...
        $daywiseSaleAmount = $this->report->daywiseSaleAmount(5);
        $daywisePaymentAmount = $this->report->daywisePaymentAmount(5);
        $daywiseAccountBalance = $this->report->daywiseAccountBalance(5);
