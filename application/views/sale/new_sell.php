...
<h2>New Sale</h2>
            ...
            ?>
<form action="<?php echo base_url(); ?>sale/sell" method="POST" id="new-sell-form">
    <table id="new_sale" border="1px">
        <tr  align="left">
            ...
            <td>
                ...
                <br/>
                <label>Item Lot<br />
                    <select name="item_lot" id="item_lot" style="color:#000"><?php foreach ($item_lotes as $lot)echo "<option value=\"".$lot->lot_id."\"".($lot->available?"":"disabled=\"\"").">".$lot->lot_id."</option>"; ?></select>
                    <script>
                        document.getElementById("item_lot").value ="<?php echo set_value("item_lot",8); ?>";
                    </script>
                </label>
                <br />
        ...
        <tr align="right">
            <td align="left">
                <label>Crates Given<br /><input type="number" id="new_sale_crate" name="crates" value='<?php echo set_value('crates','0'); ?>' required="" /></label>
                <label>Crates Security Fee ₹<br /><input type="number" id="new_sale_crate_security" name="crate_security" value='<?php echo set_value('crate_security','0'); ?>' required="" /></label>
            </td>
            <td align="right">
        ...
        <tr>
            <td>
                <input type="reset" class="btn btn-lg btn-primary btn-block no-print" value="Reset" />
            </td>
            <td><textarea placeholder="Remarks / Notes" name="notes" name="remarks"></textarea></td>
            <td>
                <label>Quik Entry<input type="checkbox" name="quick" /></label><br />
                <input type="submit" class="btn btn-lg btn-primary btn-block no-print" id="new-sell-submit-btn" value="Sell" />
            </td>
        </tr>
    </table>
</form>
